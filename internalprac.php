...
<p>1. Name of Internal Examiner: <?= isset( $firstnameInfo[ 'first_name' ] ) ? $firstnameInfo[ 'first_name' ] : 'Not available' ?> <?= isset( $lastnameInfo[ 'last_name' ] ) ? $lastnameInfo[ 'last_name' ] : 'Not available' ?> </p>
...
<p>8. Bank Account No.: <?= isset( $bankInfo[ 'accno' ] ) ? $bankInfo[ 'accno' ] : 'Not available' ?></p>
...
<p id = 'verify'><b>Signature of Examiner <br><br><br>Verfication by the Centre Superintendent ( Practical ) of Concerned Department</b></p>
<hr>
<p>Name of the Centre Superintendent ( Practical ) :</p>
<p>It is certified that the detail mentioned above are correct to the best of my knowledge and belief. The marks of the Exam has been entered in the Examination Portal and hard copy of attendance sheet and award list duly signed by External Examiner has been submitted in the Examination Divisions.</p><br>
<p>Signature of Centre Superintendent ( Practical ):</p>
<p id = 'sign'><b>Countersigned by</b></p>
<p id = "sign1"><span>Consultant ( Exam )</span><span>Dean( EA )/Dy.COE</span></p><br><hr>
