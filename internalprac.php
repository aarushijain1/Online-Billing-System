...
<body>
    ...
    <form action="iprac.php" method="POST">
        ...
        <p>8. Bank Account No.: <?= isset($bankInfo['bank_no']) ? $bankInfo['bank_no'] : 'Not available' ?></p>
        ...
        <input type="date" id="currentDate" name="currentDate" required>
            ...
            <p id = "verify"><b>Signature of Examiner <br><br><br>Examiner Verfication by the Centre Superintendent (Practical) of Concerned Department</b></p>
            <hr>
